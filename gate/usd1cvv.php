...
$sk = 'sk_live_DtvXMpChXj7yfPmh2eER4byY';
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' CVV Charged ✅ Checked by @VMRChecker <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
